...
<nav>
    <div class="menu-container">
        ...
        <img src="image/logo.png" alt="Account Image" class="logo-image">
        <div class="menuH">
        <ul class="menu">
        
            <li><a class="nav-link.active" href="#"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="#"><i class="fa fa-shopping-bag"></i> Shop</a>
                <ul class="sub-menu">
                    <li><a href="#">Food</a>
                        <ul>
                            <li><a href="#">Age 6 months - 1 year</a></li>
                            <li><a href="#">Age 1 - 3 years</a></li>
                            <li><a href="#">Age 3 - 5 years</a></li>
                        </ul>
                    </li>
                    <li><a href="#">Sanitary & Hygiene</a>
                        <ul>
                            <li><a href="#">Napkins</a></li>
                            <li><a href="#">Bathing</a></li>
                            <li><a href="#">Colognes & Creams</a></li>
                        </ul>
                    </li>
           ...
           <li><a href="useraccount.jsp"><img src="image/user.png" alt="Account Image" class="account-image"></a>
            <ul>
            <li><a href="#">LogOut</a>
            </ul>
             </li>
