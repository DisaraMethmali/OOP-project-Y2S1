...
<%@include file="Header.jsp" %>
	...
	<p>Our kids' shop is conveniently located in the heart of the city, making it easily accessible to families from all around. Nestled in a vibrant neighborhood, our store is designed to provide a joyful and colorful shopping experience for both kids and parents. You'll find us on [Store Address], where our friendly staff is always ready to assist you in finding the perfect clothing, toys, and accessories for your little ones. We've created a cozy and welcoming space for families to explore the latest trends in children's fashion and discover a world of creativity and fun. Visit us today, and let your kids embark on a delightful shopping adventure!
	</p>
