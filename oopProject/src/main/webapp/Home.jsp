...
<img src="images/pngwing.com (1).png" style="width:5%; position: absolute; top: 40px; right: 10px;" class="simg">
...
<div class="product-grid">
 ...
 <form action="createCartServlet" method="post" style="display:inline;">
            <input type="hidden" name="productId" value="${product.getProdId()}">
                <input type="hidden" name="cusid" value="${cusDetails.getId()}">
            <input type="submit" value="Add to cart" onclick="return confirm('Are you sure you want to add this to cart?');">
        </form>
</div>
